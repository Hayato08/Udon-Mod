...
public class ZaruArmorItem extends ArmorItem {
    ...
    public static final Holder<ArmorMaterial> ZARU_ARMOR_MATERIAL = register("zaru",
            ...
            }), 0, 2.0f, 0.3f, () -> UdonItems.ZARU_UDON.get());

    private static Holder<ArmorMaterial> register(String name, EnumMap<Type, Integer> typeProtection,
    ...
    public ZaruArmorItem(Type type, Properties properties) {
        super(ZARU_ARMOR_MATERIAL, type, properties);
    }
